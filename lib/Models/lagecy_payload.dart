...
// /// Build EXACT legacy JSON from cart
...
//   String? unique,
//   // Defaults below – replace with your real values if you have them
...
//       (e) => e.key == key,
//       orElse: () => TeaItem(key: key, itemId: null, name: 'Unknown', desc: '', brand: 'Meezan'),
//     );
//     final id = (it.itemId ?? '').trim();
//     if (id.isEmpty) return; // skip unknowns
//     const qtyCtn = 0;
