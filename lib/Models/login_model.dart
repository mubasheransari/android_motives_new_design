  ...
  factory LoginModel.fromJson(Map<String, dynamic> json) => LoginModel(
        ...
        journeyPlan: json["journeyPlan"] != null
            ? List<JourneyPlan>.from(
                json["journeyPlan"].map((x) => JourneyPlan.fromJson(x)))
            : [],
...
// ✅ Rest of classes (Log, Item, Reason, UserRights, Userinfo, Enums) remain the same
